...
- **Attribution lives in the capture fragment**, never a commit trailer — the standing hard rule against AI attribution in commit messages made a trailer-based approach a non-starter regardless of technical merit.
