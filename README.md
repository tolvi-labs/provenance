...
The same JSON report Provenance posts to the PR is also the handoff [Canary](https://github.com/tolvi-labs/canary) consumes as its risk/why/bindings input for test selection, with no second contract to keep in sync.
